...
## Built-in Database Editor (BETA)

We are actively developing a built-in database editor to allow modders and advanced users to directly modify game databases (e.g., ship configurations, item properties) without external tools. This feature aims to streamline the modding process and enhance customizability.

### Current Status

The built-in editor is currently under development. Initial versions will focus on:

- Loading and viewing raw database files.
- Basic editing of existing entries.
- Saving changes back to raw database files.

More advanced features, such as creating new entries, robust validation, and a more intuitive UI, will be implemented in future updates.

### How to Access (Coming Soon)

Details on how to access the built-in database editor within the game will be provided here once the feature is integrated and ready for testing. Keep an eye on the `TODO.md` file and future releases for updates!
